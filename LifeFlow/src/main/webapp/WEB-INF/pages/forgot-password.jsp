...
<head>
    ...
    <title>Forgot Password - LifeFlow Premium</title>
    ...
    <div class="v3-auth-form-container">
        <div class="v3-auth-card reveal" style="animation-delay: 0.1s;">
            <div style="text-align: center; margin-bottom: 2.5rem;">
                <h2 style="font-size: 2rem; margin-bottom: 0.5rem;">Forgot Password</h2>
                <p style="color: var(--text-muted);">Enter your email to search for your account.</p>
            </div>
            ...
            <form action="<%= request.getContextPath() %>/forgot-password" method="post">
                ...
                <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 1rem; padding: 14px;">Find Account</button>
            </form>

            <div style="margin-top: 2rem; text-align: center; font-size: 0.95rem; color: var(--text-muted);">
                Remembered your password? <a href="<%= request.getContextPath() %>/login" style="font-weight: 700;">Sign In</a>
            </div>
        </div>
    </div>
</div>
